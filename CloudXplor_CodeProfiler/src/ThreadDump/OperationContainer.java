...
public class OperationContainer {
	...
	public void getBlockedCount(BufferedWriter bw) throws IOException {
		if (bw == null) {
			...
			bw = new BufferedWriter(new FileWriter (new File("ThreadDump-" + formatter.format(date) + ".txt"), true));
		}
	...
	public void getAll() throws IOException {
		SimpleDateFormat formatter= new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss");
		Date date = new Date(System.currentTimeMillis());
		BufferedWriter bw = new BufferedWriter(new FileWriter (new File("ThreadDump-" + formatter.format(date) + ".txt"), true));
